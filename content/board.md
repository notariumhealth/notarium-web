...
Which IRS application we file is still being settled with counsel. The streamlined Form 1023-EZ is probably not open to us: the IRS treats an organization converted from a for-profit entity as a successor and routes it to the full Form 1023, which carries a higher fee and a much longer wait for a determination letter. An earlier version of this page said the 1023-EZ path was confirmed. Our own follow-up research says otherwise, so I have corrected it. I would rather a prospective director read that here than find it out after saying yes.

The nonprofit form does three things for this project:

- Opens grant channels the LLC could not access, including patient-community foundations and health-focused grantmakers.
- Locks the mission. A nonprofit cannot pivot to sell your health data. That is written into IRS Publication 557 and reinforced by the board.
- Supports long-term sustainability. Grants, tax-deductible individual donations, and volunteer time all become possible.

A working board is the anchor for all three.

## What board service looks like

Six-seat minimum, with room to grow to nine.

Three-year terms, one consecutive renewal permitted. After six consecutive years, a one-year break before re-eligibility.

Four meetings per year on video call, ninety minutes each. One in-person retreat per year (travel reimbursed when funds permit).

Committee work is two to four hours per month during active periods.

Board seats at a 501(c)(3) are volunteer positions. There is no compensation. The organization carries Directors and Officers (D&O) insurance from year one.
...
Email me at sophia@notarium.health.

An initial call is forty-five minutes and is not a commitment to serve. It is a conversation about whether the fit is real for both of us. If it is not, I would rather find out on the call than after we both invest more.
